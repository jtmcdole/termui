...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _ControllerSubscription$(_controller, onData, onError, onDone, cancelOnError, $T) {
      var t1 = $.Zone__current,
        ...
        t4 = type$.void,
        t5 = t1.registerUnaryCallback$2$1(onData, t4, $T);
      A._BufferingStreamSubscription__registerErrorHandler(t1, onError);
      t1.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t4);
      return new A._ControllerSubscription(_controller, t5, t1, t2 | t3, $T._eval$1("_ControllerSubscription<0>"));
    },
    ...
    DatabaseInvalidKeyError: function DatabaseInvalidKeyError(t0) {
      this._idb$_message = t0;
    },
    ...
    IdbIndexMeta_fromMapList(list) {
      var metas, t1, t2, t3, t4, t5, t6, t7, t8;
      if (list == null)
        return null;
      metas = A._setArrayType([], type$.JSArray_IdbIndexMeta);
      for (t1 = list.$ti, t2 = new A.ListIterator(list, list.get$length(0), t1._eval$1("ListIterator<ListBase.E>")), t3 = type$.String, t4 = type$.nullable_Object, t1 = t1._eval$1("ListBase.E"); t2.moveNext$0();) {
        t5 = t2.__internal$_current;
        t5 = (t5 == null ? t1._as(t5) : t5).cast$2$0(0, t3, t4);
        t6 = t5._source;
        t5 = t5.$ti._eval$1("4?");
        t7 = A._asString(t5._as(t6.$index(0, "name")));
        t8 = t5._as(t6.$index(0, "keyPath"));
        t8 = A._keyPathAsStringOrListOrNull(t8 == null ? A._asObject(t8) : t8);
        t8.toString;
        B.JSArray_methods.add$1(metas, new A.IdbIndexMeta(t7, t8, A._asBoolQ(t5._as(t6.$index(0, "unique"))) === true, A._asBoolQ(t5._as(t6.$index(0, "multiEntry"))) === true));
      }
      return metas;
    },
    ...
    IdbValueMapExt_getKeyValue(_this, keyPath) {
      ...
      throw A.wrapException(A.ArgumentError$("keyPath " + A.S(keyPath) + " not supported", null));
    },
    ...
    IDBJsifyExtension_jsifyValueStrict(_this) {
      ...
      if (typeof _this == "string")
        ...
        return A._asJSObject(new init.G.Date(_this._core$_value));
    ...
    IDBDartifyExtension_dartifyValueStrict(_this) {
      var jsObject, object, keys, key, jsArray, _length, list, index, t1, keys0, t2, exception, _null = null,
        value = _this;
      if (value != null && typeof value === "string")
        ...
        if (value != null && A.JSAnyUtilityExtension_instanceOfString(value, "Array")) {
          ...
          for (index = 0; index < _length; ++index) {
            t1 = jsArray[index];
            list[index] = t1 == null ? _null : A.IDBDartifyExtension_dartifyValueStrict(t1);
          }
          return list;
        } else if (value != null && A.JSAnyUtilityExtension_instanceOfString(value, "Date")) {
          t1 = A._asInt(A._asJSObject(value).getTime());
          if (t1 < -864e13 || t1 > 864e13)
            A.throwExpression(A.RangeError$range(t1, -864e13, 864e13, "millisecondsSinceEpoch", _null));
          ...
          return A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(value), 0, _null);
        ...
        try {
          ...
          keys0 = type$.JSArray_nullable_Object._as(init.G.Object.keys(jsObject));
          keys = type$.List_String._is(keys0) ? keys0 : new A.CastList(keys0, A._arrayInstanceType(keys0)._eval$1("CastList<1,String>"));
          for (t1 = J.get$iterator$ax(keys); t1.moveNext$0();) {
            key = t1.get$current();
            t2 = jsObject[key];
            t2 = t2 == null ? _null : A.IDBDartifyExtension_dartifyValueStrict(t2);
            J.$indexSet$ax(object, key, t2);
          }
          return object;
        } catch (exception) {
    ...
    VersionChangeEventNative: function VersionChangeEventNative(t0, t1) {
      this.factory = t0;
      this.idbVersionChangeEvent = t1;
      this.__VersionChangeEventNative_database_AI = $;
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_0, type$.void), $async$_delayedInit);
            case 2:
              // returning from await.
              // implicit return
    ...
    TransactionSembast$(database, meta) {
      var t1 = new A.TransactionSembast(new A._LazyCompleter(type$._LazyCompleter_Database), A._setArrayType([], type$.JSArray__TransactionAction_dynamic), meta, database);
      t1.TransactionSembast$2(database, meta);
      return t1;
    },
    _TransactionAction: function _TransactionAction(t0, t1, t2, t3) {
      var _ = this;
      _.action = t0;
      _.completer = t1;
      _.doNotAbortOnError = t2;
      _.$ti = t3;
    },
    _LazyCompleter: function _LazyCompleter(t0) {
      var _ = this;
      _._completed = false;
      _._completer = _._completedValue = _._completedError = null;
      _.$ti = t0;
    },
    TransactionSembast: function TransactionSembast(t0, t1, t2, t3) {
      var _ = this;
      _._debugId = _.sembastTransaction = null;
      _._aborted = false;
      _._completerCompleter = t0;
      _._txnActions = t1;
      _._sembastTransaction = null;
      _._inactive = false;
      _.meta = t2;
      _.database = t3;
    },
    ...
    TransactionSembast_execute_closure: function TransactionSembast_execute_closure(t0) {
      this.$this = t0;
    },
    TransactionSembast_execute__closure: function TransactionSembast_execute__closure(t0) {
      this.$this = t0;
    },
    ...
    toSembastValue(value) {
      ...
      try {
        ...
        if (t1 instanceof A.ArgumentError) {
          ...
          throw A.wrapException(A.ArgumentError$value(t1, J.get$runtimeType$(t2 == null ? A._asObject(t2) : t2).toString$0(0) + " in " + A.S(value), "not supported"));
        } else
          throw exception;
      }
    ...
    DatabaseFactorySembast: function DatabaseFactorySembast() {
    },
    SembastDatabaseFactoryMixin: function SembastDatabaseFactoryMixin() {
    },
    SembastDatabaseFactoryMixin_getDatabaseOpenHelper_newHelper: function SembastDatabaseFactoryMixin_getDatabaseOpenHelper_newHelper(t0, t1, t2) {
      this.$this = t0;
      this.path = t1;
      this.options = t2;
    },
    ...
    DatabaseOpenHelper$(factory, path, options) {
      var t1 = new A.DatabaseOpenHelper(factory, path, options, A.Lock_Lock(), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void));
      t1.openMode = B.DatabaseMode_3;
      return t1;
    },
    DatabaseOpenHelper: function DatabaseOpenHelper(t0, t1, t2, t3, t4) {
      var _ = this;
      _.factory = t0;
      _.path = t1;
      _.openMode = null;
    ...
    _toJsonEncodable(value, adapters) {
      ...
      if (A.isBasicTypeOrNull(value))
        return value;
      for (t1 = adapters.__js_helper$_map, t1 = new A.LinkedHashMapValueIterator(t1, t1._modifications, t1._first, adapters.$ti._eval$1("LinkedHashMapValueIterator<1>")); t1.moveNext$0();) {
    ...
    callbackToStream(object, $name, unwrapValue, $J, $T) {
      ...
      object[$name] = A._functionToJS1(new A.callbackToStream_eventFunction(controller, unwrapValue, $J));
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              worker = A.Worker$();
              $async$goto = 2;
              return A._asyncAwait(A.idbFactoryBrowser().open$3$onUpgradeNeeded$version("termui_audio_cache", new A.main_closure(), 1), $async$main);
            case 2:
              // returning from await.
              db = $async$result;
              t1 = worker.__Worker__outputController_A;
              t1 === $ && A.throwLateFieldNI("_outputController");
              new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$1(new A.main_closure0(db, worker));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
    ...
    callbackToStream_eventFunction: function callbackToStream_eventFunction(t0, t1, t2) {
      this.controller = t0;
      this.unwrapValue = t1;
      this.J = t2;
    },
  ...
  A._BroadcastStreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      t2.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t5);
      t1 = t1._eval$1("_BroadcastSubscription<1>");
      subscription = new A._BroadcastSubscription(_this, t6, t2, t3 | t4, t1);
  ...
  A._BufferingStreamSubscription.prototype = {
    ...
    cancel$0() {
      var t2, _this = this,
        t1 = _this._state = (_this._state & 4294967279) >>> 0;
      if ((t1 & 8) === 0) {
        t1 = _this._state = (t1 | 8) >>> 0;
        if ((t1 & 128) !== 0) {
          t2 = _this._pending;
          if (t2._state === 1)
            t2._state = 3;
  ...
  A.SplayTreeMap.prototype = {
    ...
    forEach$1(_, f) {
      ...
      while (nodes._collection$_current = null, nodes.super$_SplayTreeIterator$moveNext()) {
  ...
  A.DatabaseInvalidKeyError.prototype = {};
  ...
  A.IDBRequestExt_handleOnError_closure.prototype = {
    call$1($event) {
      ...
      if ((t1.future._state & 30) === 0) {
        t2 = A._asJSObjectQ(this._this.error);
  ...
  A.VersionChangeEventNative.prototype = {
    get$database() {
      ...
      if (value === $) {
        t1 = A._asJSObjectQ(_this.idbVersionChangeEvent.target);
        if (t1 == null)
          t1 = A._asJSObject(t1);
        value = _this.__VersionChangeEventNative_database_AI = new A.DatabaseNative(A._asJSObject(t1.result), _this.factory);
      }
      return value;
    }
  };
  A.DatabaseNative.prototype = {
    createObjectStore$1($name) {
      var t1 = A.catchNativeError(new A.DatabaseNative_createObjectStore_closure(this, $name, null, null), type$.nullable_ObjectStore);
      t1.toString;
      return t1;
    },
    transaction$2(storeNameOrStoreNames, mode) {
  ...
  A.DatabaseNative_createObjectStore_closure.prototype = {
    call$0() {
      return new A.ObjectStoreNative(A._asJSObject(this.$this.idbDatabase.createObjectStore(this.name, {keyPath: null, autoIncrement: false})));
    },
    $signature: 26
  };
  A.DatabaseNative_transaction_closure.prototype = {
    call$0() {
      var t1 = this.$this,
        idbTransaction = A._asJSObject(t1.idbDatabase.transaction(A.IDBJsifyExtension_jsifyValueStrict(this.storeNameOrStoreNames), this.mode));
  ...
  A.IdbFactoryNativeWrapperImpl.prototype = {
    ...
    open$body$IdbFactoryNativeWrapperImpl(dbName, onUpgradeNeeded, version) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, t3, exception, idbDatabase, t1, t2, completer, openRequest, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              openRequest = A._asJSObject($async$self.nativeFactory.open(dbName, version));
              t1.onUpdateNeededException = t1.onUpdateNeededFutureOr = null;
              A._EventStreamSubscription$(openRequest, "upgradeneeded", type$.nullable_void_Function_JSObject._as(new A.IdbFactoryNativeWrapperImpl_open_closure(t1, $async$self, onUpgradeNeeded)), false, type$.JSObject);
            ...
            case 3:
              ...
              t3 = t2 instanceof A._Future;
              $async$goto = t3 && t1.onUpdateNeededException == null ? 4 : 5;
              break;
            case 4:
              // then
              $async$handler = 7;
              $async$goto = 10;
              return A._asyncAwait(t3 ? t2 : A._Future$value(t2, type$.dynamic), $async$open$3$onUpgradeNeeded$version);
            case 10:
              // returning from await.
              $async$handler = 2;
              // goto after finally
            ...
            case 5:
              // join
              idbDatabase = A._asJSObject(openRequest.result);
  ...
  A.ObjectStoreNative_getObject_closure.prototype = {
    call$0() {
      ...
      t1.toString;
      return A.IDBRequestExt_dartFutureNullable(A._asJSObject(this.$this.idbObjectStore.get(t1)), type$.nullable_Object);
    },
    $signature: 24
  };
  A.ObjectStoreNative_put_closure.prototype = {
    call$0() {
      var t1 = A.IDBJsifyExtension_jsifyValueStrict(this.value),
        t2 = A.jsify(this.key);
      t2.toString;
      t2 = A.IDBRequestExt_dartFuture(A._asJSObject(this.$this.idbObjectStore.put(t1, t2)), type$.Object);
      return t2;
    },
    $signature: 23
  };
  ...
  A.TransactionNative.prototype = {
    get$_native_transaction$_completer() {
      ...
      var $async$get$completed = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = $async$self.get$_native_transaction$_completer().get$future().then$1$1(new A.TransactionNative_completed_closure($async$self), type$.Database);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.TransactionNative__completer__closure.prototype = {
    call$1($event) {
      ...
      t1 = this.completer;
      if ((t1.future._state & 30) === 0) {
        t2 = A._asJSObjectQ(this.$this.idbTransaction.error);
        t1.completeError$1(new A.DatabaseErrorNative(A._asString(t2.name), A._asString(t2.message)));
      }
    },
    $signature: 2
  ...
  A.TransactionNative_objectStore_closure.prototype = {
    call$0() {
      return new A.ObjectStoreNative(A._asJSObject(this.$this.idbTransaction.objectStore(this.name)));
    },
    $signature: 26
  };
  ...
  A._SembastVersionChangeEvent.prototype = {
    get$database() {
      ...
      t1 = t1.transaction;
      return type$.DatabaseSembast._as(t1.database);
    },
    toString$0(_) {
  ...
  A.DatabaseSembast.prototype = {
    ...
    createObjectStore$1($name) {
      var storeMeta = A.IdbObjectStoreMeta$($name, null, null, null),
        t1 = this.meta,
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t4 = t1.versionChangeTransaction;
              t4.toString;
              t7.___SembastVersionChangeEvent_request_A = new A.OpenDBRequest(t4);
              t7 = t3.call$1(t7);
              $async$goto = 4;
              return A._asyncAwait(t7 instanceof A._Future ? t7 : A._Future$value(t7, type$.void), $async$call$0);
            case 4:
              // returning from await.
            case 3:
              // join
  ...
  A.ObjectStoreSembast.prototype = {
    ...
    putImpl$2(value, key) {
      ...
      if (type$.Map_dynamic_dynamic._is(value))
        for (t1 = _this.meta, t2 = t1._indecies, t2 = new A.LinkedHashMapValueIterator(t2, t2._modifications, t2._first, A._instanceType(t2)._eval$1("LinkedHashMapValueIterator<2>")), t3 = type$.Object, t4 = type$.dynamic, t5 = type$.SembastStoreRef_Object_Object, t6 = _this.transaction, t7 = type$.DatabaseSembast; t2.moveNext$0();) {
          ...
          if (fieldValue != null) {
            ...
            if (t10 == null) {
              ...
              t10.StoreRefMixin___StoreRefMixin_name_A = t1.name;
    ...
    getObject$1(key) {
      if (!A.isValidKeyParam(key))
        A.throwExpression(new A.DatabaseInvalidKeyError("DataError: The data provided does not meet requirements. The parameter '" + key + "' is not a valid key."));
  ...
  A.ObjectStoreSembast_put_closure.prototype = {
    call$0() {
      var t1 = this.$this,
        ...
        t3 = t2.keyPath;
      if (t3 != null) {
        A.throwExpression(A.ArgumentError$("The object store uses in-line keys and the key parameter '" + key + "' was provided", null));
        if (type$.Map_dynamic_dynamic._is(value))
          key = A.IdbValueMapExt_getKeyValue(value, t3);
      }
      if (key == null && !t2.autoIncrement)
  ...
  A._LazyCompleter.prototype = {
    get$future() {
      var t1, t2, _this = this;
      if (_this._completed) {
        t1 = _this._completedError;
        t2 = _this.$ti;
        if (t1 != null) {
          t1 = A._interceptUserError(t1, null);
          t2 = new A._Future($.Zone__current, t2._eval$1("_Future<1>"));
          t2._asyncCompleteErrorObject$1(t1);
          return t2;
        } else
          return A.Future_Future$value(_this._completedValue, t2._precomputed1);
      }
      t1 = _this._completer;
      if (t1 == null) {
        t1 = _this.$ti;
        t1 = _this._completer = new A._AsyncCompleter(new A._Future($.Zone__current, t1._eval$1("_Future<1>")), t1._eval$1("_AsyncCompleter<1>"));
      }
      return t1.future;
    },
    complete$1(value) {
      ...
      if (!_this._completed) {
        ...
        _this._completedValue = value;
        completer = _this._completer;
        if (completer != null && (completer.future._state & 30) === 0)
          completer.complete$1(value);
      }
    },
    get$isCompleted() {
  ...
  A.TransactionSembast.prototype = {
    TransactionSembast$2(database, meta) {
      new A.TransactionSembast_closure(this).call$0();
    },
    _newAbortException$0() {
      return new A.DatabaseException0("Aborted");
    },
    execute$1$1(action, $T) {
      var txnAction, t1, _this = this, doNotAbordOnError = null;
      $T._eval$1("0/()")._as(action);
      try {
        if (_this._aborted) {
          t1 = _this._newAbortException$0();
          throw A.wrapException(t1);
        }
        if (_this._inactive) {
          t1 = A.DatabaseError$("DatabaseInactiveError: transaction database closed");
          throw A.wrapException(t1);
        }
        t1 = doNotAbordOnError;
        if (t1 == null)
          t1 = false;
        txnAction = new A._TransactionAction(action, new A._AsyncCompleter(new A._Future($.Zone__current, $T._eval$1("_Future<0>")), $T._eval$1("_AsyncCompleter<0>")), t1, $T._eval$1("_TransactionAction<0>"));
        B.JSArray_methods.add$1(_this._txnActions, txnAction);
        t1 = txnAction.completer;
        return t1.future;
      } finally {
        if (_this._sembastTransaction == null)
          _this._sembastTransaction = new A.TransactionSembast_execute_closure(_this).call$0();
      }
    },
    get$completed() {
      var $async$goto = 0,
      ...
      var $async$get$completed = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              if ($async$self._aborted)
                throw A.wrapException($async$self._newAbortException$0());
              $async$returnValue = $async$self._completerCompleter.get$future();
              // goto return
              $async$goto = 1;
              break;
            case 1:
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A._delayedInit(), $async$call$0);
            case 3:
              // returning from await.
              if (t2.get$isCompleted()) {
                // goto return
              ...
              $async$goto = t1._sembastTransaction == null ? 4 : 5;
              break;
            case 4:
              // then
              $async$goto = 6;
  ...
  A.TransactionSembast_execute_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Null),
        $async$handler = 1, $async$errorStack = [], $async$self = this, e, t1, t2, exception, completer, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              t1 = $async$self.$this;
              t2 = type$.DatabaseSembast;
              $async$goto = 6;
              return A._asyncAwait(t2._as(t1.database).db.transaction$1$1(new A.TransactionSembast_execute__closure(t1), type$.Null), $async$call$0);
            case 6:
              // returning from await.
              t1._completerCompleter.complete$1(t2._as(t1.database));
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              e = A.unwrapException($async$exception);
              t1 = A._asObject(e);
              t2 = $async$self.$this._completerCompleter;
              if (!t2._completed) {
                t2._completed = true;
                t2._completedError = t1;
                completer = t2._completer;
                if (completer != null && (completer.future._state & 30) === 0)
                  completer.completeError$2(t1, null);
              }
              // goto after finally
              $async$goto = 5;
              break;
  ...
  A.TransactionSembast_execute__closure.prototype = {
    call$1(txn) {
      return this.$call$body$TransactionSembast_execute__closure(txn);
    },
    $call$body$TransactionSembast_execute__closure(txn) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Null),
        $async$handler = 1, $async$errorStack = [], $async$next = [], $async$self = this, actions, txnAction, result, e, st, e0, actions0, txnAction0, t1, t2, t3, t4, actions1, t5, t6, _i, t7, t8, t9, exception, $async$exception, $async$exception1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 = t1._txnActions, t3 = type$.nullable_StackTrace, t4 = type$._TransactionAction_dynamic;
            case 6:
              // for condition
              // trivial condition
              actions1 = A.List_List$_of(t2, t4);
              actions = actions1;
              B.JSArray_methods.clear$0(t2);
              t5 = actions, t6 = t5.length, _i = 0;
            case 8:
              // for condition
              if (!(_i < t5.length)) {
                // goto after for
              ...
              txnAction = t5[_i];
              if (t1._aborted) {
                t7 = txnAction.completer;
                if ((t7.future._state & 30) !== 0)
                  A.throwExpression(A.StateError$("Future already completed"));
                t7._completeErrorObject$1(A._interceptUserError(new A.DatabaseException0("Aborted"), null));
              }
              $async$handler = 12;
              result = txnAction.action$0();
              $async$goto = result instanceof A._Future ? 15 : 16;
              break;
            case 15:
              // then
              $async$goto = 17;
              return A._asyncAwait(result, $async$call$1);
            case 17:
              // returning from await.
              result = $async$result;
            case 16:
              ...
              t7 = txnAction.completer;
              t8 = t7.$ti;
              t9 = t8._eval$1("1/?")._as(result);
              t7 = t7.future;
              if ((t7._state & 30) !== 0)
                A.throwExpression(A.StateError$("Future already completed"));
              t7._asyncComplete$1(t8._eval$1("1/")._as(t9));
              $async$handler = 3;
              // goto after finally
              $async$goto = 14;
              break;
            case 12:
              ...
              if ((t7.future._state & 30) !== 0)
                A.throwExpression(A.StateError$("Future already completed"));
              t7._completeErrorObject$1(A._interceptUserError(t8, t9));
              txnAction.toString;
              if (!t1._inactive)
                t1._aborted = true;
              // goto after finally
            ...
            case 9:
              // for update
              t5.length === t6 || (0, A.throwConcurrentModificationError)(t5), ++_i;
              // goto for condition
              $async$goto = 8;
              break;
            case 10:
              // after for
              $async$goto = t2.length === 0 ? 18 : 19;
              break;
            case 18:
              // then
              $async$goto = 20;
              return A._asyncAwait(A._delayedInit(), $async$call$1);
            case 20:
              // returning from await.
              if (t2.length === 0) {
                // goto after for
            ...
            case 4:
              ...
              t1._inactive = true;
              t1 = t1._txnActions;
              actions = A.List_List$_of(t1, type$._TransactionAction_dynamic);
              actions0 = actions;
              B.JSArray_methods.clear$0(t1);
              for (t1 = actions0, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
                txnAction0 = t1[_i];
                t3 = txnAction0.completer;
                if ((t3.future._state & 30) !== 0)
                  A.throwExpression(A.StateError$("Future already completed"));
                t3._completeErrorObject$1(A._interceptUserError(new A.DatabaseException0("Aborted"), null));
              }
              // goto the next finally handler
              $async$goto = $async$next.pop();
              break;
  ...
  A.Cooperator.prototype = {
    ...
    cooperate$0() {
      ...
      if (_this.get$needCooperate()) {
        ...
        if (!_this._paused) {
          _this._paused = true;
          return A.Future_Future$delayed(A.Duration$(1), t1).then$1$1(new A.Cooperator_cooperate_closure(_this), t1);
        } else
          return A.Future_Future$delayed(A.Duration$(1), t1);
      } else
        return null;
    }
  };
  ...
  A.DatabaseFactorySembast.prototype = {$isDatabaseFactory: 1};
  A.SembastDatabaseFactoryMixin.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 4;
              return A._asyncAwait($async$self.getDatabaseOpenHelper$2(path, options), $async$openDatabaseWithOptions$2);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$result.openDatabase$0(), $async$openDatabaseWithOptions$2);
            case 3:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
    ...
    getDatabaseOpenHelper$2(path, options) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.DatabaseOpenHelper),
        $async$returnValue, $async$self = this, t1, helper;
      var $async$getDatabaseOpenHelper$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = new A.SembastDatabaseFactoryMixin_getDatabaseOpenHelper_newHelper($async$self, path, options);
              helper = $async$self.SembastDatabaseFactoryMixin__databaseOpenHelpers.$index(0, path);
              $async$goto = helper == null ? 3 : 5;
              break;
            case 3:
              // then
            ...
            case 5:
              // else
              $async$goto = helper._closing ? 6 : 7;
              break;
            case 6:
              // then
              $async$goto = 8;
              return A._asyncAwait(helper._closeCompleter.future, $async$getDatabaseOpenHelper$2);
            case 8:
              // returning from await.
              $async$returnValue = t1.call$0();
              // goto return
      ...
      return A._asyncStartSync($async$getDatabaseOpenHelper$2, $async$completer);
    },
  ...
  A.SembastDatabaseFactoryMixin_getDatabaseOpenHelper_newHelper.prototype = {
    call$0() {
      var t1 = this.$this,
        t2 = this.path,
        helper = A.DatabaseOpenHelper$(t1, t2, this.options);
  ...
  A.SembastDatabase.prototype = {
    ...
    txnJdbDeltaImport$1(revision) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this, records, entry, record, delta, entries, t1, t2, t3, t4, t5, _i, store, key, minRevision, $async$temp1;
          ...
          switch ($async$goto) {
            ...
            case 10:
              ...
              for (t2 = records, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
                ...
                key = A.RecordSnapshotMixin.prototype.get$key.call(record);
                store.setRecordInMemory$1(record);
                if (A._isInt(key))
                  if (key > store.lastIntKey)
                    store.lastIntKey = key;
              }
            case 5:
              // join
    ...
    _closeStart$0() {
      var _this = this;
      _this.openHelper._closing = true;
      _this._storageJdbRevisionUpdateSubscription = null;
      _this.listener.close$0();
      _this.changesListener._changes_listener$_stores.clear$0(0);
    },
    _lockedClose$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$handler = 1, $async$errorStack = [], $async$self = this, exception, $async$exception;
      var $async$_lockedClose$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait($async$self.flush$0(), $async$_lockedClose$0);
            case 6:
              // returning from await.
              $async$handler = 1;
              // goto after finally
            ...
            case 5:
              ...
              $async$goto = 7;
              return A._asyncAwait($async$self.openHelper.lockedCloseDatabase$0(), $async$_lockedClose$0);
            case 7:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_lockedClose$0, $async$completer);
    },
    close$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
      ...
      var $async$_notifyListeners$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              for (t1 = type$.ImmutableSembastRecord, t2 = $async$self.listener._listener$_stores, t3 = $async$self._pendingListenerContent;;) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 4:
              ...
              t1._closeStart$0();
              $async$goto = 9;
              return A._asyncAwait(t1._lockedClose$0(), $async$call$0);
            case 9:
              // returning from await.
              throw $async$exception;
              // goto after finally
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait($async$self.$this._lockedClose$0(), $async$call$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.DatabaseListener.prototype = {
    close$0() {
      var t1, t2, t3, t4, t5, _i, recordListeners, _i0;
      for (t1 = this._listener$_stores, t2 = new A.LinkedHashMapValueIterator(t1, t1._modifications, t1._first, A._instanceType(t1)._eval$1("LinkedHashMapValueIterator<2>")); t2.moveNext$0();) {
        t3 = t2.__js_helper$_current;
        for (t4 = t3.get$_listener$_stores(), t5 = t4.length, _i = 0; _i < t5; ++_i)
          t4[_i].close$0();
        for (t3 = t3.get$_listener$_records().get$values(), t4 = t3.length, _i = 0; _i < t4; ++_i) {
          recordListeners = t3[_i];
          for (t5 = recordListeners.length, _i0 = 0; _i0 < t5; ++_i0)
            recordListeners[_i0].close$0();
        }
      }
      t1.clear$0(0);
    }
  ...
  A.SembastStore.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 7:
              // join
              t1 = key;
              $async$self.txnPutSync$3(txn, value, t1 == null ? A._asObject(t1) : t1);
    ...
    txnPutRecordSync$2(txn, record) {
      var t1, t2, t3, _this = this,
        recordKey = A.RecordSnapshotMixin.prototype.get$key.call(record);
      if (A._isInt(recordKey))
        if (recordKey > _this.lastIntKey)
          _this.lastIntKey = recordKey;
      t1 = _this.database;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 9:
              // returning from await.
              t9 = key;
              record = $async$self.txnGetRawImmutableRecordSync$1$2(txn, t9 == null ? A._asObject(t9) : t9, t3);
              if (record != null && record.SembastRecordMixin__deleted !== true) {
    ...
    txnClear$1(txn) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t1, deletedKeys, $async$temp1, $async$temp2;
      var $async$txnClear$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 5;
              return A._asyncAwait($async$self.txnDeleteAll$2(txn, A.List_List$from(new A.LinkedHashMapKeysIterable(t1, A._instanceType(t1)._eval$1("LinkedHashMapKeysIterable<1>")), false, type$.nullable_Object)), $async$txnClear$1);
            case 5:
              // returning from await.
            ...
            case 4:
              ...
              $async$temp2 = deletedKeys;
              $async$goto = 6;
              return A._asyncAwait($async$self.txnDeleteAll$2(txn, A.List_List$from(new A._SplayTreeKeyIterable(t1, t1.$ti._eval$1("_SplayTreeKeyIterable<1,_SplayTreeMapNode<1,2>>")), false, type$.nullable_Object)), $async$txnClear$1);
            case 6:
              // returning from await.
              $async$temp1.addAll$1($async$temp2, $async$result);
              $async$returnValue = deletedKeys;
      ...
      return A._asyncStartSync($async$txnClear$1, $async$completer);
    }
  };
  ...
  A.callbackToStream_eventFunction.prototype = {
    call$1($event) {
      var t1 = this.controller,
        t2 = A._instanceType(t1)._precomputed1._as(this.unwrapValue.call$1(this.J._as(A._asObject($event))));
  ...
  A.Worker.prototype = {
    Worker$0() {
      var _null = null;
      this.__Worker__outputController_A = new A._AsyncStreamController(_null, _null, _null, _null, type$._AsyncStreamController_dynamic);
      A.callbackToStream(A._asJSObject(init.G.self), "onmessage", new A.Worker_closure(this), type$.JSObject, type$.Null);
    }
  };
  A.Worker_closure.prototype = {
    call$1(e) {
      var t2, t3,
        data = A._asJSObject(e).data,
        t1 = this.$this.__Worker__outputController_A;
      t1 === $ && A.throwLateFieldNI("_outputController");
      t2 = A._instanceType(t1);
      t2._precomputed1._as(data);
      t3 = t1._state;
      if (t3 >= 4)
      ...
      if ((t3 & 1) !== 0)
        ...
        t1._ensurePendingEvents$0().add$1(0, new A._DelayedData(data, t2._eval$1("_DelayedData<1>")));
    },
    $signature: 2
  };
  A.main_closure.prototype = {
    call$1($event) {
      $event.get$database().createObjectStore$1("assets");
    },
    $signature: 69
  };
  A.main_closure0.prototype = {
    call$1(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, path, readTxn, store, cachedData, response, arrayBuffer, bytes, writeTxn, writeStore, e, action, t1, t2, exception, $async$exception;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = type$.Map_dynamic_dynamic._is(data) ? 3 : 4;
              break;
            case 3:
              // then
              action = A._asStringQ(data.$index(0, "action"));
              path = A._asStringQ(data.$index(0, "path"));
              $async$goto = action === "load" && path != null ? 5 : 6;
              break;
            case 5:
              // then
              $async$handler = 8;
              t1 = $async$self.db;
              readTxn = t1.transaction$2("assets", "readonly");
              store = readTxn.objectStore$1("assets");
              $async$goto = 11;
              return A._asyncAwait(store.getObject$1(path), $async$call$1);
            case 11:
              // returning from await.
              cachedData = $async$result;
              $async$goto = 12;
              return A._asyncAwait(readTxn.get$completed(), $async$call$1);
            case 12:
              // returning from await.
              if (cachedData != null && type$.Uint8List._is(cachedData)) {
                A.JSObjectUnsafeUtilExtension_callMethod(init.G, "postMessage", A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["action", "loaded", "path", path, "bytes", cachedData, "cached", true], type$.String, type$.Object)), type$.nullable_Object);
                // goto return
                $async$goto = 1;
                break;
              }
              t2 = init.G;
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t2.window).fetch(path)), type$.JSObject), $async$call$1);
            case 13:
              // returning from await.
              response = $async$result;
              if (!A._asBool(response.ok)) {
                t1 = A.Exception_Exception("HTTP error! status: " + A.S(A.getProperty(response, "status", type$.int)));
                throw A.wrapException(t1);
              }
              $async$goto = 14;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(response.arrayBuffer()), type$.NativeArrayBuffer), $async$call$1);
            case 14:
              // returning from await.
              arrayBuffer = $async$result;
              bytes = A.NativeUint8List_NativeUint8List$view(arrayBuffer, 0, null);
              writeTxn = t1.transaction$2("assets", "readwrite");
              writeStore = writeTxn.objectStore$1("assets");
              $async$goto = 15;
              return A._asyncAwait(writeStore.put$2(bytes, path), $async$call$1);
            case 15:
              // returning from await.
              $async$goto = 16;
              return A._asyncAwait(writeTxn.get$completed(), $async$call$1);
            case 16:
              // returning from await.
              A.JSObjectUnsafeUtilExtension_callMethod(t2, "postMessage", A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["action", "loaded", "path", path, "bytes", bytes, "cached", false], type$.String, type$.Object)), type$.nullable_Object);
              $async$handler = 2;
              // goto after finally
              $async$goto = 10;
              break;
            case 8:
              ...
              e = A.unwrapException($async$exception);
              t1 = type$.String;
              A.JSObjectUnsafeUtilExtension_callMethod(init.G, "postMessage", A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["action", "error", "path", path, "error", J.toString$0$(e)], t1, t1)), type$.nullable_Object);
              // goto after finally
              $async$goto = 10;
              break;
            case 7:
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(_ = A._StreamIterator.prototype, "get$_onData", "_onData$1", 52);
    ...
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 41, 0, 0);
    ...
    _instance_1_u(A._FinderData.prototype, "get$addRecord", "addRecord$1", 60);
    _static_2(A, "utils__compareKey$closure", "compareKey", 16);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.DatabaseError, [A.DatabaseReadOnlyError, A.DatabaseStoreNotFoundError, A.DatabaseTransactionStoreNotFoundError, A.DatabaseInvalidKeyError, A.DatabaseErrorNative]);
    ...
    _inherit(A._DatabaseFactoryMemory_SembastDatabaseFactory_SembastDatabaseFactoryMixin, A.DatabaseFactorySembast);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Future<Null>()", "Null(JSObject)", "bool(Object?)", "~(@,@)", "~(Object,StackTrace)", "@(@)", "Future<@>()", "Null()", "~(@)", "~(~())", "Null(@)", "bool(Object?,Object?)", "int(Object?)", "Future<~>()", "int()", "int(@,@)", "MapEntry<String,Object?>(@,@)", "bool(Finder?,ImmutableSembastRecord)", "Future<Null>(Transaction)", "ImmutableSembastRecord(TxnRecord)", "~(Object?,Object?)", "int(String?)", "Future<Object>()", "Future<Object?>()", "~(JSObject)", "ObjectStoreNative()", "TransactionNative()", "String()", "Object(Object?)", "int(IdbIndexMeta,IdbIndexMeta)", "Object?(Object?)", "Completer<Object?>()", "Database(@)", "~(String)", "List<IdbObjectStoreMeta>(List<RecordSnapshot<String,Object>?>)", "@(String)", "Future<int>(Transaction)", "Null(List<IdbObjectStoreMeta>)", "~(IdbObjectStoreMeta)", "Null(Database0,int,int)", "Set<0^>()<Object?>", "@(@,String)", "bool(RecordSnapshot<Object?,Object?>)", "Null(RecordSnapshot<Object,Object>?)", "Future<Object>(List<@>)", "Object(Object)", "bool()", "~(Zone?,ZoneDelegate?,Zone,~())", "DatabaseOpenHelper()", "Future<@>(String)", "Future<@>(Map<@,@>)", "~(Object?)", "Future<@>(int?,int?)", "Future<Object?>(Transaction)", "Future<SembastDatabase>()", "Future<Object?>(SembastTransaction)", "Null(Object,StackTrace)", "int(SembastRecord,SembastRecord)", "int(ImmutableSembastRecord,ImmutableSembastRecord)", "bool(ImmutableSembastRecord)", "Future<~>(SembastTransaction)", "Future<int>(SembastTransaction)", "String(Timestamp)", "Timestamp(String)", "String(Blob)", "Blob(String)", "~(int,@)", "~(Object)", "Null(VersionChangeEvent)", "Future<~>(@)", "Null(@,StackTrace)", "Null(~())", "~(RecordSnapshot<String,Object>?)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DatabaseOpenHelper: findType("DatabaseOpenHelper"),
      ...
      JSArray__TransactionAction_dynamic: findType("JSArray<_TransactionAction<@>>"),
      ...
      _LazyCompleter_Database: findType("_LazyCompleter<Database>"),
      ...
      _TransactionAction_dynamic: findType("_TransactionAction<@>"),
      bool: findType("bool"),
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "databaseFactoryMemory", "$get$databaseFactoryMemory", () => {
      var t1 = type$.String;
      return new A.DatabaseFactoryMemory(A.LinkedHashMap_LinkedHashMap$_empty(t1, type$.bool), A.LinkedHashMap_LinkedHashMap$_empty(t1, type$.SembastDatabase), A.LinkedHashMap_LinkedHashMap$_empty(t1, type$.DatabaseOpenHelper));
    });
