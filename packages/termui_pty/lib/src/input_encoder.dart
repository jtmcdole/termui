...
class InputEncoder {
  ...
  static String _encodeKeyEvent(ev.KeyEvent event) {
    ...
    switch (event.type) {
      ...
      case ev.KeyType.insert:
        return '\x1b[2~';
      case ev.KeyType.f1: return '\x1bOP';
      case ev.KeyType.f2: return '\x1bOQ';
      case ev.KeyType.f3: return '\x1bOR';
      case ev.KeyType.f4: return '\x1bOS';
      case ev.KeyType.f5: return '\x1b[15~';
      case ev.KeyType.f6: return '\x1b[17~';
      case ev.KeyType.f7: return '\x1b[18~';
      case ev.KeyType.f8: return '\x1b[19~';
      case ev.KeyType.f9: return '\x1b[20~';
      case ev.KeyType.f10: return '\x1b[21~';
      case ev.KeyType.f11: return '\x1b[23~';
      case ev.KeyType.f12: return '\x1b[24~';
      default:
        return '';
    }
  }
  ...
  static String _encodeMouseEvent(ev.MouseEvent event) {
    ...
    if (event.type == ev.MouseEventType.move || event.type == ev.MouseEventType.drag) {
      cb |= 32;
    }
